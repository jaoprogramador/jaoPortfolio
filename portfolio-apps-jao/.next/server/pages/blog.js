...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Blog); /* import Head from "next/head";
...
// ⚡️ getStaticProps sin useContext
export async function getStaticProps() {
  const language = "es"; // O puedes definirlo dinámicamente desde un archivo de configuración
  const posts = getAllPosts(language, ["slug", "title", "image", "preview", "author", "date"]);

  return {
    props: {
      posts,
      language, // Pasamos el idioma como prop
    },
  };
}
