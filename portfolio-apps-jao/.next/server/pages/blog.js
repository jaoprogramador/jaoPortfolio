...
/* harmony import */ var _context_LanguageContext__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(4745);
...
const Blog = ({ initialPosts  })=>{
    ...
    // Contexto de idioma
    const { language  } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useContext)(_context_LanguageContext__WEBPACK_IMPORTED_MODULE_11__/* .LanguageContext */ .A);
    const { 0: posts , 1: setPosts  } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(initialPosts);
...
var __webpack_exports__ = __webpack_require__.X(0, [57,835,134,382], () => (__webpack_exec__(8547)));
