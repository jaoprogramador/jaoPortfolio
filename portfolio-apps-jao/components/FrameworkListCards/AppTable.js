...
const categories = [
  ...
  { title: "Spring AI con java 21", filter: "Spring IA", icon:"/img/icons/springAI-icon.png", descBlock:"En este apartado veremos como conectar mi proyecto con ChatGPT para hacer un API que le pregunta a ChatGPT y nos devuelve resultados" },
